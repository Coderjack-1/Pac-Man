...
class enemy:
    def __init__(self,pos,app,number):
        self.app = app
        self.grid_pos = pos
    ...
    def update(self):
        ...
        if self.set_target != self.grid_pos:
    ...
    def set_target(self):
        if self.personality == "Inky" or self.personality == "Blinky":
    ...
    def set_speed(self):
        if self.personality in ["Inky"]:
            speed = 2
        elif self.personality in ["Blinky"]:
            speed = 1.5
        elif self.personality in ["Pinky"]:
            speed = 1
        else:
            speed = 0.5
        return speed
